                ...
                while server_active and not self.manual_kill_flag:
                    ...
                    with open(self.log_file_path, 'r') as log_file:
                        ...
                        for line in log_file:
                            ...
                            # NOT FUNCTIONAL WITH CURRENT UPDATE
                            
                            if log_is_currently_softlocked_on_empty_voting_screen (line):
                                self.restart_server (f"Server reloaded due to being softlocked in an empty voting screen")
                                server_active = False
                                break
...
def log_is_currently_softlocked_on_empty_voting_screen (line):
    match = re.serach (r'LogGameMode: ProcessServerTravel: M_ServerDefault', line)
    if match:
        return True
